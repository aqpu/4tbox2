...
export function ToolPageShell({ children }: { children: ReactNode }) {
  ...
  // id único para favoritos, basado en la ruta
  ...
  const categoryLabel = categoryLabels[categorySlug] || "Tools";
  ...
  return (
    <div className="space-y-4">
      {/* Header común para TODAS las herramientas debajo de /tools */}
